					...
					<td width="720" height="716">					
						<table id="__01" width="720" height="716" border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<h3 style="display:inline; line-height:47px;color:#444;height:47px">　　　人才招聘</h3>
								</td>
							</tr>
							<tr>
								<td width="720" height="669" style="background:#D5D2C9">
									...
									<!-- 主体部分开始 -->
											  <%
												...
												'''''模型表名称
												Dim ModelTable:ModelTable ="user_rec"
											...
											%>
											  <%
														...
														set rs = UICon.Query("select * from user_rec where ID="&ItemID&"")
														UIcon.execute("update user_rec set Hots=Hots +1 where id="&ItemID&"")
