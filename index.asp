          ...
          <td width="229" height="714" background="images/index_main_right_01.jpg" ><table id="__01" width="229" height="714" border="0" cellpadding="0" cellspacing="0" >
            ...
            <tr>
			  ...
			  <ul id="main_right_01">
								...
								%>
									<li><a  href="product.asp?categoryid=<%=rs("id")%>&amp;itemid=&lei=<%=rs("categoryname")%>" style="color:#fff" title="<%=rs("categoryname")%>"  ><%=rs("categoryname")%></a></li>	
								<%
									rs.movenext
									next
									rs.close
            ...
            <tr>
              <td width="229" height="208"><div class="main_right_02">
				...
				<p>　</p>
                <p>联系电话：025-84807010</p>
                <p>移动手机:13951954330</p>
                <p>地址:南京市玄武区后半山园2号（陆军指挥学院）商务中心</p>
              </div></td>
            </tr>
            <tr>
            ...
            <tr>
              <td width="229" height="256"><div class="main_right_02">
                <p>活动策划执行、广告设计制作、影视制作剪辑、外籍模特（时装秀、化妆品、手表珠宝、模特杂志封面拍摄、泳装秀、内衣秀、TVC）、户外媒体代理、各类晚会举办、产品推广、港台明星演出经纪代理等文化交流项目，并对外出租桁架，灯光音响，舞台等专业设备。
</p>
              </div></td>
            </tr>
          </table></td>
