					...
					<td width="720" height="716">					
						<table id="__01" width="720" height="716" border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<h3 style="display:inline; line-height:47px;color:#444;height:47px">　　　<% if trim(request("lei"))<>"" then 
															  ...
															  <tr>
																...
																<td align="content" style="padding-top:10px;">
																			  ...
																			  <table style="margin-bottom:30px;" width="190" height="190"  border="0" cellpadding="0" cellspacing="0">
																				...
																				<tr>
																				  <td height="20px"  style="line-height:20px"  align="center" valign="middle"><span style=""><div align="center"><a href="product_in.asp?categoryID=<%=rs("categoryID")%>&amp;itemid=<%=rs("id")%>"><%=rs("Title")%></a></div></span></td>
																				</tr>
																				</table>	
																</td>
																<% 
